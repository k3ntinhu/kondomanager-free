  ...
  <Teleport to="body">
    ...
    >
      <div class="space-y-3 text-sm text-slate-600">
        <p>Stai per eliminare la fattura <strong>{{ fattura.numero_documento }}</strong>.</p>
        <p>Questa azione cancellerà il documento dal database e rimuoverà le scritture contabili associate. L'operazione è <strong>irreversibile</strong>.</p>
      </div>
    </ConfirmDialog>
