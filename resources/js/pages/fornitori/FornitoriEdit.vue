                    ...
                    <div class="flex items-center p-1 bg-slate-100 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-800 shrink-0">
                        ...
                        <button 
                            ...
                            :class="form.stato === 'sospeso' 
                                ...
                                : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300'"
                        >
                            {{ trans('fornitori.states.suspended') }}
                        </button>
            ...
            <CardContent class="space-y-6">
                <div class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <Input id="codice_fiscale" v-model="form.codice_fiscale" class="mt-1 bg-white uppercase font-mono" :placeholder="trans('fornitori.label.tax_code')" />
            ...
            <CardContent class="space-y-6">
                <div class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <Input v-model="form.provincia" :placeholder="trans('fornitori.forms.province')" class="mt-1 bg-white uppercase" maxlength="2" />
            ...
            <CardContent class="space-y-6">
                <div class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <Input id="codice_ateco" v-model="form.codice_ateco" :placeholder="trans('fornitori.view.labels.ateco_code')" class="mt-1 bg-white font-mono" />
                    </div>
