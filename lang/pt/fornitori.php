...
return [
    ...
    'header' => [
        ...
        'list_description'              => "Gerencie o registo de fornecedores e profissionais associados aos seus condomínios.",
        'view_title'                    => "Detalhes do fornecedor",
        'referents_list_title'          => "Referentes do fornecedor",
        'contacts_title'                => "Referentes do fornecedor",
        'documents_list_title'          => "Documentos do fornecedor",
        'documents_title'               => "Documentos do fornecedor",
    ...
    'label' => [
        ...
        'email'                => 'Email',
        'website'              => 'Website',
        'cciaa_number'         => 'Registo CCIAA',
        'cciaa_date'           => 'Data de registo',
        'ateco'                => 'Código ATECO',
        ...
        'address_empty'        => 'Morada não disponível',
        'notes_empty'          => 'Sem notas adicionais.',
        'document'             => 'Documento',
    ...
    'placeholder' => [
        ...
        'filter_name'           => 'Procurar fornecedor...',
    ...
    'dialogs' => [
        ...
        'detach_record_description'   => 'Esta ação não pode ser revertida. O registo será desassociado e deixará de poder visualizar os dados do fornecedor.',
