...
return [
    ...
    'error_conto_locked_by_rate_plan'   => "Unable to delete: this expense is linked to an approved, issued, or closed installment plan.",
    ...
    'piani_rate' => [
        ...
        'table' => [
            ...
            'balances_included_title' => 'Opening balances included in this plan',
        ...
        'immobili' => [
            ...
            'anagrafiche' => [
                ...
                'labels' => [
                    ...
                    'registry_associated' => 'Linked registry record',
                    'type' => 'Type',
                ...
                'placeholders' => [
                    ...
                    'notes' => 'Internal notes (not visible to residents)',
                ],
                'new' => [
                    'head_title' => 'Link registry record to unit',
                    'page_title' => 'Link registry record',
                    'page_subtitle_named' => 'Link a registry record to unit :name (Unit :unit).',
                    'breadcrumb' => 'Link registry',
                    'back_to_list' => 'Back to list',
                    'guides' => [
                        'association_title' => 'Direct link',
                        'association_description' => 'Select the registry record and define its relation to this unit.',
                        'quota_title' => 'Share management',
                        'quota_description' => 'Set the competence percentage used in allocations.',
                        'period_title' => 'Validity period',
                        'period_description' => 'Use dates to track turnovers and ownership changes.',
                    ],
                    'sections' => [
                        'subject_title' => 'Linked subject',
                        'subject_description' => 'Choose the registry record and relation type for this unit.',
                        'validity_title' => 'Link validity',
                        'validity_description' => 'Define start/end dates and operational notes.',
                    ],
                    'help' => [
                        'available_subjects_title' => 'Available subjects',
                        'available_subjects_description' => 'The list includes records already registered in the system.',
                        'missing_someone' => 'Missing someone?',
                        'go_to_registry_prefix' => 'Create it first in',
                        'registry_link' => 'Registry',
                        'go_to_registry_suffix' => 'and then come back to link it here.',
                        'quota_title' => 'How share works',
                        'warning_label' => 'Warning:',
                        'warning_text' => 'active shares for the same unit should total 100%.',
                        'quota_description' => 'Use the share to distribute responsibilities across linked subjects.',
                        'quota_example_single' => 'Example: single subject -> 100%',
                        'quota_example_shared' => 'Example: two subjects -> 50% + 50%',
                        'takeover_title' => 'Turnover and closing',
                        'takeover_description_1' => 'When a subject changes, set an end date on the previous link.',
                        'takeover_description_2' => 'Then create the new link with the correct start date.',
                        'takeover_hint' => 'Tip: keeping non-overlapping periods avoids allocation issues.',
                    ],
                    'messages' => [
                        'notes_not_printed' => 'Internal notes are not printed in resident-facing documents.',
                    ],
                    'actions' => [
                        'save' => 'Save',
                    ],
                ...
                'edit' => [
                    'head_title' => 'Edit registry association',
                    'page_title' => 'Edit association',
                    'page_subtitle_named' => 'Update the registry association for unit :name.',
                    'breadcrumb' => 'Edit association',
                    'back_to_list' => 'Back to list',
                    'guides' => [
                        'role_title' => 'Relation type',
                        'role_description' => 'Update how the subject is related to this unit.',
                        'quota_title' => 'Share review',
                        'quota_description' => 'Adjust the percentage to keep allocations consistent.',
                        'period_title' => 'Association period',
                        'period_description' => 'Edit dates to reflect ownership or tenancy changes.',
                    ],
                    'sections' => [
                        'subject_title' => 'Linked subject',
                        'subject_description' => 'Review the linked record and update relation parameters.',
                        'validity_title' => 'Association validity',
                        'validity_description' => 'Update dates and internal notes.',
                    ],
                    'messages' => [
                        'registry_not_editable' => 'The linked registry record cannot be changed in edit mode.',
                    ],
                    'help' => [
                        'quota_description' => 'Share defines the competence percentage assigned to the subject.',
                        'quota_example' => 'Example: 50.00 means fifty percent competence.',
                        'takeover_description' => 'Set an end date to close the association while keeping history.',
                    ],
                    'actions' => [
